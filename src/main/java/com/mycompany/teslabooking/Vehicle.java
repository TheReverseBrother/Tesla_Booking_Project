...
public class Vehicle
{
    ...
    public Vehicle(String make, String model, int milesPerKH, int seats, String registration, double costPerMile, double mileage, Location location, boolean inDepot) {
        this.make = make;
        this.model = model;
